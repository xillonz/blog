...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/api/checkLogin').then(function (response) {
      console.log(response);

      _this.setLoggedIn(response.data);
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])(['setLoggedIn']), {
    logout: function logout() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/logout').then(function (response) {
        console.log(response);

        _this2.setLoggedIn(false);
      }).catch(function (error) {
        console.log(error);
      });
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])(['loggedIn'])),
  created: function created() {
    this.fetchData();
  },
  methods: {
      ...
      [
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            ...
            class: { invalid: _vm.submitted && !_vm.email },
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            class: { invalid: _vm.submitted && !_vm.password },
...
/* harmony import */ var _components_Articles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Articles */ "./resources/js/components/Articles.vue");
/* harmony import */ var _components_Article__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/Article */ "./resources/js/components/Article.vue");




vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_wysiwyg__WEBPACK_IMPORTED_MODULE_3___default.a, {});
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    path: '/',
    name: 'home',
    component: _components_Articles__WEBPACK_IMPORTED_MODULE_6__["default"]
  }, {
    path: '/articles/:id',
    name: 'articles.show',
    component: _components_Article__WEBPACK_IMPORTED_MODULE_7__["default"]
  }, {
    path: '/login',
    name: 'login',
...
__webpack_require__(/*! C:\Users\Willo\Websites\Figured Exercise\blog\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Willo\Websites\Figured Exercise\blog\resources\sass\app.scss */"./resources/sass/app.scss");
